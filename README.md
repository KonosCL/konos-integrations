...
----------------------------------------------- | ----------- | ------------------------------- 
[buk_connector](buk_connector/)                 | 18.0.3.0.0  | Streamlined connector for data synchronization with Odoo.
[connector_fintoc](connector_fintoc/)           | 18.0.4.0.0  | Retrieve bank statements directly from Fintoc into Odoo.

### Contributing

Please check out the [Contributing](.github/CONTRIBUTING.md) file for guidelines about how to proceed.
